...
// Adding SVG paths to emphasis tags
const ems = document.querySelectorAll('em')
ems.forEach(em => {
  em.classList.add('group', 'relative')
  const span = document.createElement('span')
  span.setAttribute('class', 'absolute -bottom-2 left-0 right-0 w-full h-4 rotate-180')
  span.innerHTML = `
    <svg
